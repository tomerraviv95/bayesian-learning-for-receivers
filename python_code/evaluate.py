...
from python_code.detectors.bayesian_dnn.bayesian_dnn_trainer import BayesianDNNTrainer
...
from python_code.detectors.deepsic.seq_deepsic import SeqDeepSICTrainer
