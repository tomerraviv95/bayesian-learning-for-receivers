...
from python_code.utils.constants import Phase, HALF, TRAIN_VAL_SPLIT_RATIO
...
class BayesianVNETTrainer(Trainer):
    ...
    def calc_loss(self, est: LossVariable, tx: torch.IntTensor, phase: Phase) -> torch.Tensor:
        """
